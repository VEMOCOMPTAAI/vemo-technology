    ...
    <main className="min-h-screen bg-[#f6f7fb] text-[#111a33]">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-10 py-5">
          <div>
            <p className="text-2xl font-black">VEMO TECH Admin</p>
      ...
      <section className="mx-auto max-w-[1440px] px-10 py-10">
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-[2rem] bg-white p-6 ">
            ...
            <p className="mt-2 text-4xl font-black text-[#9F1239]">
              ${totalRevenue}
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 px-5 py-3 font-bold outline-none focus:border-[#9F1239] md:w-80"
              />

              <a
                href="/api/admin/orders/export"
                className="rounded-2xl border border-slate-200 bg-white px-5 py-3 font-black hover:border-[#9F1239]"
              >
                Export CSV
              </a>
                    ...
                    <tr key={order.id} className="bg-slate-50">
                      ...
                      <td className="rounded-r-2xl px-4 py-4">
                        <a
                          ...
                          className="rounded-xl bg-[#9F1239] px-4 py-3 text-sm font-black text-white"
                        >
                          Ouvrir
                        </a>
                      </td>
