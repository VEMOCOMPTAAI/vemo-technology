          ...
          <div className="mt-10 rounded-[2rem] bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 flex flex-col gap-3 md:flex-row">
              <input
                ...
                className="min-w-0 flex-1 rounded-2xl border border-slate-200 px-5 py-4 font-bold outline-none focus:border-[#c51f32]"
              />

              <button
                onClick={() => loadOrder()}
                disabled={loading}
                className="rounded-2xl bg-[#c51f32] px-6 py-4 font-black text-white shadow-lg disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading
                  ? isFr
                    ? "Chargement..."
                ...
                <div className="mt-8 rounded-[2rem] bg-slate-50 p-6">
                  <div className="flex items-center justify-between gap-5">
                    ...
                    <div className="text-right">
                      ...
                      <p className="mt-2 text-3xl font-black text-[#c51f32]">
                        {progress}%
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 h-3 overflow-hidden rounded-full bg-white">
                    <div
                      className="h-full rounded-full bg-[#c51f32]"
