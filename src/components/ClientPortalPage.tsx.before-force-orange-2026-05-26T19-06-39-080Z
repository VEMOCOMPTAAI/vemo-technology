      ...
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <a href={`/${lang}/espace-client`} className="flex items-center gap-3">
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0e7490] text-xl font-black text-white shadow-lg shadow-cyan-900/20">
              V
            </span>
            <span>
          ...
          <nav className="hidden items-center gap-10 text-sm font-black md:flex">
            ...
            <a
              ...
              className="border-b-2 border-[#0e7490] pb-2 text-[#0e7490]"
            >
              {t.documents}
            </a>
            ...
            <div className="flex rounded-2xl border border-slate-200 bg-white p-1 shadow-sm">
              <a
                ...
                className={cn(
                  ...
                  lang === "fr" ? "bg-[#0e7490] text-white" : "text-slate-700"
                )}
              >
                FR
              </a>
              <a
                ...
                className={cn(
                  "rounded-xl px-3 py-2 text-xs font-black",
                  lang === "en" ? "bg-[#0e7490] text-white" : "text-slate-700"
                )}
              >
                EN
              </a>
        ...
        {!loading && error && (
          <div className="mx-auto max-w-3xl rounded-[2rem] border border-red-100 bg-white p-10 text-center shadow-xl shadow-slate-200/70">
            ...
            <div className="mt-8 flex justify-center gap-3">
              <a
                href={`/${lang}/connexion`}
                className="rounded-2xl bg-[#0e7490] px-6 py-4 text-sm font-black text-white"
              >
                {t.login}
              </a>
              <a
            ...
            >
              <div className="border-b border-slate-100 p-8">
                ...
                <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                  ...
                  <div className="rounded-full bg-cyan-50 px-5 py-3 text-sm font-black text-[#0e7490]">
                ...
                <div className="mt-7 grid gap-3 md:grid-cols-[1fr_210px]">
                  <input
                    ...
                    className="rounded-2xl border border-slate-200 bg-white px-5 py-4 text-sm font-bold outline-none transition focus:border-[#0e7490] focus:ring-4 focus:ring-cyan-100"
                  />

                  <select
                    value={statusFilter}
                    onChange={(event) => setStatusFilter(event.target.value)}
                    className="rounded-2xl border border-slate-200 bg-white px-5 py-4 text-sm font-black outline-none transition focus:border-[#0e7490] focus:ring-4 focus:ring-cyan-100"
                  >
                  ...
                  return (
                    <article
                      ...
                      className={cn(
                        ...
                        active ? "border-[#0e7490]" : "border-slate-100"
                      )}
                    >
                      <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
                        <div className="flex items-start gap-5">
                          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[#0e7490] text-sm font-black text-white shadow-lg shadow-cyan-900/20">
                          ...
                          {doc.file_url ? (
                            <>
                              <button
                                ...
                                className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black text-[#0e7490] transition hover:border-[#0e7490]"
                              >
                                {t.preview}
                              </button>
                              ...
                              <a
                                ...
                                target="_blank"
                                download
                                className="rounded-2xl bg-[#0e7490] px-5 py-3 text-sm font-black text-white shadow-lg shadow-cyan-900/20"
                              >
                                {t.download}
                              </a>
                            </>
                ...
                <div className="flex items-center justify-between gap-4 border-b border-slate-100 p-6">
                  ...
                  {selectedDocument?.file_url && (
                    <a
                      ...
                      target="_blank"
                      className="rounded-xl border border-slate-200 px-3 py-2 text-xs font-black text-slate-500 hover:text-[#0e7490]"
                    >
                      ↗
                    </a>
                  )}
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-5 grid gap-3 sm:grid-cols-2">
                      <a
                        href={selectedDocument.file_url}
                        target="_blank"
                        className="rounded-2xl border border-slate-200 bg-white px-5 py-4 text-center text-sm font-black text-[#0e7490]"
                      >
                        {t.openPreview}
                      </a>
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isClient
                              ? "rounded-tr-md bg-[#0e7490] text-white"
                ...
                <div className="border-t border-slate-100 bg-white p-5">
                  <div className="flex gap-3">
                    <textarea
                      ...
                      className="min-h-[54px] flex-1 resize-none rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm font-bold outline-none transition focus:border-[#0e7490] focus:ring-4 focus:ring-cyan-100"
                    />
                    ...
                    <button
                      ...
                      className="rounded-2xl bg-[#0e7490] px-5 py-4 text-sm font-black text-white shadow-lg shadow-cyan-900/20 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {sendingReply ? "..." : t.send}
                    </button>
                  </div>
