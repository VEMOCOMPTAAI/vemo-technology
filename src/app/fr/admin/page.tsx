...
const clients = [
  { name: "ABDEL CH", pack: "Premium", state: "New Mexico", amount: "199 USD", payment: "En vérification", file: "En attente" },
  { name: "Client LLC", pack: "—", state: "—", amount: "—", payment: "En vérification", file: "En attente" },
  { name: "Client LLC", pack: "—", state: "—", amount: "—", payment: "En vérification", file: "En attente" },
];

export default function FrAdminPage() {
  return (
