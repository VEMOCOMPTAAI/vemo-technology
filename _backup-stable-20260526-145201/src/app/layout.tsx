import VemoFormMemoryRuntime from "@/components/VemoFormMemoryRuntime";
import VemoBankTransferRuntime from "@/components/VemoBankTransferRuntime";
import VemoWhatsappButton from "@/components/VemoWhatsappButton";
...
export default function RootLayout({
  ...
  return (
    <html lang="fr">
      <body>
        {children}
        <VemoFormMemoryRuntime />
        <VemoBankTransferRuntime />
        <VemoWhatsappButton />
        <Analytics />
      </body>
    </html>
