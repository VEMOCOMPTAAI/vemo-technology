        ...
        <div className="w-full rounded-[2rem] bg-white p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="mt-8">
            ...
            <input
              ...
              className="mt-2 w-full rounded-2xl border border-slate-200 px-5 py-4 font-bold outline-none focus:border-[#9F1239]"
              placeholder="Mot de passe admin"
            />

            {errorMessage && (
              <div className="mt-4 rounded-2xl bg-rose-50 px-5 py-4 text-sm font-black text-rose-700">
                {errorMessage}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-6 w-full rounded-2xl bg-[#9F1239] px-6 py-4 font-black text-white shadow-lg disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <a
            href="/fr"
            className="mt-5 block text-center text-sm font-black text-slate-500 hover:text-[#9F1239]"
          >
            Retour au site
          </a>
        </div>
