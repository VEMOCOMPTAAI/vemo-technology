      ...
      <section className="mx-auto flex min-h-screen max-w-md items-center px-6">
        <div className="w-full rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/70">
          ...
          <p className="mt-2 text-sm font-semibold leading-6 text-slate-500">
            Entrez le mot de passe admin pour accéder Ã  la gestion clients,
          ...
          <input
            ...
            className="mt-6 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm font-bold outline-none focus:border-[#123A63] focus:ring-4 focus:ring-orange-100"
          />
          ...
          <button
            ...
            onClick={login}
            disabled={loading}
            className="mt-4 w-full rounded-xl bg-[#F15A24] px-5 py-3 text-sm font-black text-white disabled:bg-slate-300"
          >
