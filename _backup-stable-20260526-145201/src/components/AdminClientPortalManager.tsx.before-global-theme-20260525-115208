        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={loadClients}
              className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black shadow-sm transition hover:border-[#0e7490] hover:text-[#0e7490]"
            >
              Actualiser
            </button>
            ...
            <button
              type="button"
              onClick={logoutAdmin}
              className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black text-slate-950 shadow-sm transition hover:border-[#0e7490] hover:text-[#0e7490]"
            >
              Déconnexion
            </button>
          </div>
        ...
        {!loading && selectedClient && (
          <div className="space-y-8">
            ...
            <section className="grid gap-8 xl:grid-cols-[0.95fr_1.05fr]">
              <div className="space-y-8">
                <section className="overflow-hidden rounded-[2rem] border border-slate-100 bg-white shadow-xl shadow-slate-200/70">
                  <div className="bg-gradient-to-r from-[#0e7490] to-[#0f2a4f] p-7 text-white">
                  ...
                  <form onSubmit={uploadDocument} className="grid gap-5 p-7 md:grid-cols-2">
                    <label className="block">
                      ...
                      <select
                        ...
                        onChange={(event) => {
                          ...
                          if (value === "operating_agreement") setDocTitle("Operating Agreement");
                    ...
                    <button
                      type="submit"
                      disabled={savingDoc}
                      className="w-fit rounded-2xl bg-[#0e7490] px-7 py-4 text-sm font-black text-white shadow-lg shadow-cyan-900/20 transition hover:bg-[#0b647c] disabled:opacity-60"
                    >
                        ...
                        >
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex items-start gap-4">
                              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#0e7490] text-xs font-black text-white">
                          ...
                          <div className="mt-4 flex flex-wrap gap-2">
                            {doc.file_url && (
                              <a
                                href={doc.file_url}
                                target="_blank"
                                className="inline-flex rounded-xl bg-[#0e7490] px-4 py-2 text-xs font-black text-white"
                              >
                                Ouvrir
                              </a>
                            )}
                ...
                <section className="rounded-[2rem] border border-slate-100 bg-white p-7 shadow-xl shadow-slate-200/70">
                  ...
                  <form onSubmit={sendMessage} className="mt-6 space-y-5">
                    ...
                    <textarea
                      ...
                      className="min-h-[160px] w-full resize-none rounded-2xl border border-slate-200 bg-white px-5 py-4 text-sm font-black outline-none transition focus:border-[#0e7490] focus:ring-4 focus:ring-cyan-100"
                    />
