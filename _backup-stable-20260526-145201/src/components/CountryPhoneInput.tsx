  ...
  return (
    <label className="block">
      ...
      <div className="grid gap-3 md:grid-cols-[240px_1fr]">
        <div className="relative">
          <select
            ...
            className="w-full appearance-none rounded-2xl border border-slate-200 bg-white px-4 py-4 pr-10 text-sm font-black outline-none transition focus:border-[#0e7490] focus:ring-4 focus:ring-cyan-100"
          >
            {countries.map((item) => (
      ...
      <div className="mt-2 flex flex-wrap items-center gap-2 text-xs font-black">
        ...
        <span className="rounded-full bg-cyan-50 px-3 py-1 text-[#0e7490]">
          {selected.dial}
        </span>
