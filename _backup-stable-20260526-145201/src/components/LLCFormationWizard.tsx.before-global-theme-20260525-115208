...
const copy = {
  ...
  en: {
    ...
    entity: "Entity type",
    jurisdiction: "State",
    stateFee: "Official State filing fees",
        ...
        <div className="absolute z-[80] mt-2 w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
          <div className="border-b border-slate-100 p-3">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm font-bold outline-none focus:border-[#9F1239]"
            />
          </div>
          ...
          <div className="max-h-72 overflow-y-auto p-2">
            {filtered.map((country) => (
              <button
                ...
                className={[
                  "flex w-full items-center justify-between gap-3 rounded-xl px-3 py-3 text-left text-sm font-bold hover:bg-rose-50",
                  country.code === value ? "bg-rose-50 text-[#9F1239]" : "text-[#111a33]",
                ].join(" ")}
              >
                <span className="flex min-w-0 items-center gap-3">
    ...
    <div>
      ...
      <div className="mt-2 grid gap-3 md:grid-cols-[300px_1fr]">
        ...
        <input
          ...
          className={[
            "vemo-input",
            phoneTouched && !phoneValid ? "border-rose-400" : "",
          ].join(" ")}
        />
      </div>
  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "border-[#9F1239] bg-rose-50 shadow-sm"
          : "border-slate-200 bg-white hover:border-[#9F1239]/60",
      ].join(" ")}
    >
...
function ToggleService({
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <span
          className={[
            ...
            checked ? "bg-[#9F1239]" : "bg-slate-200",
          ].join(" ")}
        >
          <span
            className={[
      ...
      <p className="shrink-0 font-black text-[#9F1239]">{price}</p>
    </button>
  );
}
                  ...
                  <div
                    className={[
                      "flex h-8 w-8 items-center justify-center rounded-full border-2 text-xs font-black",
                        ...
                        ? "border-[#9F1239] bg-[#9F1239] text-white"
                        : active
                          ? "border-[#9F1239] bg-white text-[#9F1239]"
        ...
        <div className="vemo-card rounded-[2rem] p-7 md:p-9">
          {step === 0 && (
            <div>
              ...
              <div className="mt-5 h-px bg-rose-100" />
          ...
          {step === 1 && (
            <div>
              ...
              <div className="mt-8 rounded-[1.5rem] bg-rose-50 p-6">
            ...
            <div>
              ...
              <div className="mt-7 rounded-[1.5rem] border border-slate-200 bg-white p-6">
                <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                  <div>
                    <p className="text-xs font-black uppercase tracking-[0.2em] text-[#9F1239]">
                  ...
                  <div className="rounded-2xl bg-slate-50 px-6 py-4 text-right">
                    ...
                    <p className="mt-1 text-3xl font-black text-[#9F1239]">
                      {money(total)}
                    </p>
                  </div>
                </div>
        ...
        <aside className="vemo-card sticky top-28 rounded-[2rem] p-7">
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-black text-[#9F1239]">
          ...
          <div className="mt-7 rounded-[1.25rem] bg-slate-100 p-5">
            <div className="flex items-center justify-between">
              ...
              <p className="text-2xl font-black text-[#9F1239]">{money(total)}</p>
            </div>
          </div>
          ...
          <div className="mt-7 space-y-3">
            {submitError && (
              <div className="rounded-2xl bg-rose-50 px-4 py-3 text-sm font-black text-rose-700">
                {submitError}
              </div>
            )}
