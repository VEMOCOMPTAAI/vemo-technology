          ...
          {plans.map((plan) => (
            <article
              ...
              className={[
                ...
                plan.featured
                  ? "border-[#0e7490] ring-4 ring-cyan-100"
                  : "border-slate-200",
              ].join(" ")}
            >
              {plan.badge && (
                <div className="absolute right-6 top-6 rounded-full bg-[#0e7490] px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-white">
                  {plan.badge}
                </div>
              )}
              ...
              <div className="mt-7 flex-1 space-y-3">
                {plan.items.map((item) => (
                  ...
                  >
                    <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-cyan-50 text-xs font-black text-[#0e7490]">
                      ✓
                    </span>
